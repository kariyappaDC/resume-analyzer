...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='kavan',db='cv')
...
def run():
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            save_image_path = 'C:/Users/kavan/OneDrive/Desktop/AI-Resume-Analyzer-main/AI-Resume-Analyzer-main/App/Uploaded_Resumes/'+pdf_file.name
